...
STL mesh via a ROS-style package:// URI.
...
class Link:
    ...
    def make_link_xml(self):
        ...
        # Mesh URI: package://{robot_name}/meshes/{link_name}.stl
        mesh_uri = 'package://{}/meshes/{}.stl'.format(self.robot_name, self.name)
        ...
        mesh_v.attrib = {'filename': mesh_uri, 'scale': '0.001 0.001 0.001'}
        ...
        mesh_c.attrib = {'filename': mesh_uri, 'scale': '0.001 0.001 0.001'}
