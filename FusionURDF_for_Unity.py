# Author: syuntoku14, Dheena2k2, Lentin Joseph (original)
# Refactored: Unity URDF export — no xacro, no ROS 2 packages
#
# Description
# -----------
...
# design.  After the STL export is done we restore the design by rolling the
...
# were involved.
#
# The files written to disk (URDF + STL) are NOT rolled back — only the
...
def run(context):
    ...
    try:
        ...
        welcome = (
            ...
            "This tool generates a self-contained URDF file and STL meshes\n"
        ...
        # ------------------------------------------------------------------ #
        # 6. Export STL meshes — restore all Fusion design changes afterwards #
        # ------------------------------------------------------------------ #
